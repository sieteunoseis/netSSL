...
export const applicationTypeField: FieldDefinition = {
  ...
  validation: {
    name: "isIn",
    options: ["general", "vos", "ise", "catalyst_center"],
  },
};
...
export const autoRenewField: FieldDefinition = {
  ...
  description:
    "Automatically renew certificate before expiration (requires API-based DNS provider)",
  defaultValue: false,
...
export const isEnabledField: FieldDefinition = {
  ...
  description:
    "When disabled, connection will be hidden from dashboard but can still be managed",
  defaultValue: true,
};
...
export const sshCertPathField: FieldDefinition = {
  ...
  description:
    "Full path on the remote server where the certificate file should be installed",
  optional: true,
  validation: { name: "isAscii", options: "" },
...
export const sshKeyPathField: FieldDefinition = {
  ...
  description:
    "Full path on the remote server where the private key file should be installed",
  optional: true,
  validation: { name: "isAscii", options: "" },
  visibleWhen: { field: "enable_ssh", is: true },
};
...
export const sshChainPathField: FieldDefinition = {
  ...
  description:
    "Full path for the certificate chain file (optional - leave blank to skip chain upload)",
  optional: true,
  validation: { name: "isAscii", options: "" },
  visibleWhen: { field: "enable_ssh", is: true },
};
...
export const sshRestartCommandField: FieldDefinition = {
  ...
  description:
    "Shell command to execute after certificate installation to restart services. Leave blank to skip.",
  optional: true,
  validation: { name: "isAscii", options: "" },
  visibleWhen: { field: "enable_ssh", is: true },
};
...
export const hostnameVosField: FieldDefinition = {
  ...
  description:
    "Hostname only - do not include domain name (e.g., 'server01' not 'server01.domain.com')",
  validation: {
    name: "matches",
    options: "^[a-zA-Z0-9]([a-zA-Z0-9\\-]{0,61}[a-zA-Z0-9])?$",
  },
};
...
export const applicationTypeInfoVosField: FieldDefinition = {
  ...
  label: "",
  description:
    "Includes: CUCM, CUC, IM&P, and other VOS-based systems. Uses API to automatically generate CSR and upload certificate after obtaining from SSL provider. Note: Without SSH enabled, users will need to manually restart Tomcat service after certificate installation.",
};
...
export const autoRestartServiceField: FieldDefinition = {
  ...
  description:
    "Automatically restart Cisco Tomcat service after certificate installation",
  defaultValue: false,
  visibleWhen: { field: "enable_ssh", is: true },
};
...
export const hostnameIseField: FieldDefinition = {
  ...
  description:
    "FQDN of the ISE Primary Admin Node. Used for all API operations and node discovery.",
  validation: { name: "isFQDN", options: { allow_numeric_tld: true } },
};
...
export const domainIseField: FieldDefinition = {
  ...
  placeholder: "e.g., example.com",
  description:
    "DNS zone for ACME challenge records. Also combined with the monitoring hostname to form the FQDN that netSSL checks.",
  validation: { name: "isFQDN", options: { allow_numeric_tld: true } },
};
...
export const altNamesIseField: FieldDefinition = {
  ...
  description:
    "Additional FQDNs to include as SANs. Use this for portal or guest hostnames that users browse to. Each SAN domain requires a DNS challenge.",
  optional: true,
  validation: { name: "isAscii", options: "" },
};
...
export const iseApplicationSubtypeField: FieldDefinition = {
  ...
  selectOptions: [
    {
      value: "multi_use",
      label: "Multi-Use — Admin, EAP, Portal (Recommended)",
    },
  ...
  validation: {
    name: "isIn",
    options: ["multi_use", "admin", "eap", "guest", "portal", "saml"],
  },
};
...
export const iseUsageInfoMultiUseField: FieldDefinition = {
  ...
  label: "",
  description:
    "Multi-Use certificate covers Admin, EAP, and Portal roles. Monitors the Admin interface on port 443.",
...
export const iseUsageInfoAdminField: FieldDefinition = {
  ...
  label: "",
  description:
    "Admin certificate for Server and DataConnect Authentication. Monitors port 443.",
...
export const iseUsageInfoEapField: FieldDefinition = {
  ...
  label: "",
  description:
    "EAP Authentication certificate for Server Authentication. Monitors port 443.",
...
export const iseUsageInfoDtlsField: FieldDefinition = {
  ...
  label: "",
  description:
    "DTLS Authentication certificate for RADIUS DTLS Server Authentication. Monitors port 443.",
...
export const iseSubtypeInfoGuestField: FieldDefinition = {
  ...
  label: "",
  description:
    "Guest Portal certificate on port 8443. Used for Portal Server Authentication.",
...
export const iseSubtypeInfoPortalField: FieldDefinition = {
  ...
  label: "",
  description:
    "Sponsor Portal certificate on port 8445. Used for Portal Server Authentication.",
...
export const iseUsageInfoPxgridField: FieldDefinition = {
  ...
  label: "",
  description:
    "pxGrid certificate for Client and Server Authentication. Monitors port 443.",
...
export const iseNodesField: FieldDefinition = {
  ...
  description:
    "The first node becomes the certificate CN and generates the CSR. All listed nodes receive the signed certificate.",
  validation: { name: "isAscii", options: "" },
};
...
export const iseCertImportConfigField: FieldDefinition = {
  ...
  description:
    "Default configuration sent to the ISE certificate import API. Modify any values to override the defaults. Only changed fields need to be included \u2014 they will be merged with the defaults shown above.",
  optional: true,
  validation: { name: "isJSON", options: "" },
  rows: 6,
};
...
export const hostnameGeneralField: FieldDefinition = {
  ...
  description:
    "Server hostname - can be a name, wildcard (*), or blank for domain-only certificates",
  validation: {
    name: "matches",
    options: "^(\\*|[a-zA-Z0-9]([a-zA-Z0-9\\-]{0,61}[a-zA-Z0-9])?)?$",
  },
...
export const applicationTypeInfoGeneralField: FieldDefinition = {
  ...
  label: "",
  description:
    "Includes: ESXi, other non-Cisco applications, or any system requiring certificate management. Enable SSH to automatically deploy certificates via SFTP, or download certificate files for manual installation.",
};
...
export const hostnameCatalystCenterField: FieldDefinition = {
  ...
  description:
    "Hostname of the Catalyst Center appliance — do not include domain name",
  validation: {
    name: "matches",
    options: "^[a-zA-Z0-9]([a-zA-Z0-9\\-]{0,61}[a-zA-Z0-9])?$",
  },
...
export const applicationTypeInfoCatalystCenterField: FieldDefinition = {
  ...
  label: "",
  description:
    "Cisco Catalyst Center (formerly DNA Center). Uses token-based REST API to import certificates. CSR is generated locally — no SSH required.",
};
